...
pragma solidity ^0.6.12;
    ...
    contract Toke Name is Context, IERC20, Ownable {
        ...
        address payable public burnAddress = 0x0000000000000000000000000000000000000000;
        ...
        constructor (address payable charityWalletAddress) public {
            ...
            IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x10ED43C718714eb63d5aA57B78B54704E256024E); // pancakeswapv2 for BSC network
        ...
        function sendTokenToDeath(uint256 amount) private {
        ...
        function _reflectFee(uint256 rFee, uint256 tFee) private {
         ...
         //to recieve BNB from pancakeswap when swaping
        ...
        function _getTValues(uint256 tAmount) private view returns (uint256, uint256, uint256, uint256) {
            ...
            uint256 tTransferAmount = tAmount.sub(tFee).sub(tCharity).sub(tBurn);
            return (tTransferAmount, tFee, tCharity, tBurn);
        }
        ...
        function _setBurnFee(uint256 burnFee) external onlyOwner() {
            require(burnFee >= 1 && burnFee <= 5, 'burnFee should be in 1 - 5');
            _burnFee = burnFee;
        }
